import { VideoCarousel } from "@/sections/VideoSection/components/VideoCarousel";

export const VideosSection = () => {
    return (
        <section className="bg-orange-100 box-border caret-transparent px-[15px] py-[60px] md:px-0">
            <div className="box-border caret-transparent max-w-none w-full mx-auto px-[15px] md:max-w-[1140px]">
                ...
                <h2 className="text-violet-900 text-[38px] box-border caret-transparent leading-[45.6px] my-2.5">
